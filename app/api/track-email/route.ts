        ...
        if (currentStatus === 'qualificacao' || currentStatus === 'prospeccao') {
          ...
          if (resendKey && lead.email) {
            const workspaceSenders: Record<string, { name: string; email: string; color: string; phone: string; site: string }> = {
              lottus:    { name: 'getLOG/Lottustech', email: 'danilo@grandy.ia.br', color: '#16a34a', phone: '(41) 99949-9815', site: 'www.gettms.com.br' },
              iota:      { name: 'IOTA',              email: 'danilo@grandy.ia.br', color: '#1a56db', phone: '(41) 99949-9815', site: 'www.gettms.com.br' },
              splice:    { name: 'Splice',            email: 'danilo@grandy.ia.br', color: '#ea580c', phone: '(41) 99949-9815', site: 'www.gettms.com.br' },
              connectfy: { name: 'Connectfy',         email: 'danilo@grandy.ia.br', color: '#7c3aed', phone: '(41) 99949-9815', site: 'www.gettms.com.br' },
            };
