...
const SENDERS: Record<string, any> = {
  lottus: { email: 'crm@itskilltech.com.br', name: 'getLOG/Lottustech', displayName: 'Danilo Cabral', contactEmail: 'danilo@lottustech.com.br', phone: '(41) 99949-9815', color: '#0066ff', colorLight: '#0052cc' },
  iota:   { email: 'crm@itskilltech.com.br', name: 'IOTA', displayName: 'Danilo Cabral', contactEmail: 'danilo@iota.com.br', phone: '(41) 99949-9815', color: '#6938ef', colorLight: '#5b21b6' },
  splice: { email: 'crm@itskilltech.com.br', name: 'Splice', displayName: 'Danilo Cabral', contactEmail: 'danilo@splice.com.br', phone: '(41) 99949-9815', color: '#079455', colorLight: '#15803d' },
};
